        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <Card className="border-blue-800 hover:border-primary/30 transition-colors">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="border-blue-800 focus:border-primary"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="border-blue-800 focus:border-primary resize-none"
                    placeholder="Cuéntanos sobre tu proyecto o consulta..."
                  />
                </div>

                <Button type="submit" className="w-full bg-blue-900 hover:bg-blue-800 text-primary-foreground py-3">
